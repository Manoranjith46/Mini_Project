...
exports.generatePlaceholderImage = exports.generateImageFromIssue = void 0;
...
const getPromptForIssueType = (issueType, title, description) => {
...
const generateImageFromIssue = (issueType, title, description) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b;
    try {
        ...
        if (error.response) {
            ...
            console.error("   Data length:", ((_b = error.response.data) === null || _b === void 0 ? void 0 : _b.length) || 0);
        }
        // Return null if generation fails - fallback will be used
        return null;
    }
});
exports.generateImageFromIssue = generateImageFromIssue;
// Fallback: Generate a placeholder image using a reliable service
const generatePlaceholderImage = (issueType) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const response = yield axios_1.default.get(placeholderUrl, {
            responseType: "arraybuffer",
            timeout: 10000,
        });
        ...
        try {
            ...
            const fallbackResponse = yield axios_1.default.get(fallbackUrl, {
                responseType: "arraybuffer",
                timeout: 10000,
            });
