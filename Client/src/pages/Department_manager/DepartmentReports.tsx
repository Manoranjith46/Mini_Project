        ...
        >
          <div>
            ...
            <p className="text-gray-600 mt-2">
              Manage issues for {user?.place || user?.department}
            </p>
          </div>
          <Button
            onClick={fetchDepartmentStats}
            disabled={refreshing}
            className="bg-gradient-to-r from-orange-600 to-orange-700 hover:from-orange-700 hover:to-orange-800 text-white gap-2"
          >
            <RefreshCw
